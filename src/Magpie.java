...
public class Magpie {
	...
	public String getGreeting() {
		return "Hello, im your Mr. A chat bot.";
	}
	...
	public String getResponse(String statement) {
		...
		{
			// find whats inbetween
			int iPos = findKeyword(statement, "I");
			int youPos = findKeyword(statement, "you");

			// isolate SOMETHING
			String what = statement.substring(iPos + "I".length(), youPos).trim();

			response = "Why do you " + what + " me?";
		}

		// I LIKE something
		else if (findKeyword(statement, "I like") >= 0) {
			// indentify where "I like" is
			int pos = findKeyword(statement, "I like");
			// cut substring of thing you like
		...
		// I WANT something
			...
			// chop off the after stuff
			String thing = statement.substring(pos + 6).trim();

			response = "Would you realy be happy if you had " + thing + "?";
		}
	...
	private String getRandomResponse() {
		...
		if (whichResponse == 0) {
			...
			response = "WHAT.. Did you call me a stinky Pengvin";
		}
